...
2026-09-19. 사용자 승인으로 회원가입 변경 `881d163`을 main에 fast-forward 병합하고 `feat/rag-service`에서 후속 구현했다. 이후 사용자가 요약 5개 실제 등록·무료 API 검수를 승인하여 등록과 검수를 마쳤다. 이 기능의 main 병합은 별도 승인 전이다. 외부 배포·Naver Cloud 구매는 수행하지 않는다.
