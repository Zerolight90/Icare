...
class FamilyBoundaryTest {
    ...
    @Test void chatOwnershipIsCheckedBeforeRetrievalAndModel() {
        ...
        var ai = new GeminiService(model, vector, messages, rooms, users, config, new AiRequestGuard(4000, 1024, 5), new ChatContextService(messages, mock(FamilyAccessService.class)));
